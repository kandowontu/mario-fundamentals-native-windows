...
self-test from an empty working directory, regenerates 201 Macintosh and 210 DOS no-window
presentation frames at the exact 512×384 and 320×200 logical sizes, compares 25 independent
original-output references (eleven stable layouts, seven source-timed Macintosh intro instants,
all five source-timed DOS game intros, and two focused Macintosh Yacht actor/cup checks) when the

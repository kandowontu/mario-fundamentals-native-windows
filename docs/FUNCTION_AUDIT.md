...
- The silent presentation gate regenerates 171 Macintosh and 166 DOS logical-resolution frames,
  covering the title completion path, every menu selection, 21 samples for every game intro, eight
  opening states for every game, and the Macintosh Yacht roll/settle sequence.
